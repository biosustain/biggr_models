# -*- coding: utf-8 -*-
#
# biggr_models documentation build configuration file, created by
...
autoapi_dirs = [join(SRC_PATH, "biggr_models")]
...
from biggr_models import __version__ as release  # noqa: E402
